...
contract Domains is ERC721URIStorage {
  ...
  constructor(string memory _t1d) payable ERC721("Ninja Name Service", "NNS") {
    t1d = _t1d;
    console.log("%s name service deployed", _t1d);
  }
...
function valid(string calldata name) public pure returns(bool) {
  ...
  function register(string calldata name) public payable {
      ...
      require(msg.value >= _price, "Not enough Matic paid");
        ...
        string memory _name = string(abi.encodePacked(name, ".", t1d));
    ...
    console.log("Registering %s.%s on the contract with tokenID %d", name, t1d, newRecordId);
